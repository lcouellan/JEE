...
public class PersonsDBHandler {
     ...
     */
    public static SQLPersonDB getDb () throws NamingException, SQLException {
    ...
    private static void initialize () throws NamingException, SQLException {
        ...
        String table=initialContext.doLookup("java:comp/env/tablePerson");
        PersonsDBHandler.db=new SQLPersonDB(PersonsDBHandler.getLink(host,database,username,password),table);
    }
