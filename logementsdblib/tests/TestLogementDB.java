...
public class TestLogementDB {
    ...
    public static void main (String [] args) {
        ...
        try {
            ...
            db=new SQLLogementDB(link,"tableLogementsTest");
    ...
    protected static void test (SQLProductDB db) throws SQLException, AssertionError {
        ...
        db.create(new Logement(350,2,"adresse 1 test db"));
        db.create(new Logement(250,5,"adresse 2 test db"));
        // Liste de tous les logements de la DB
        List<Logement> res=db.retrieveAll();
        ...
        assert "adresse 1 test db".equals(p.getAdresse());
